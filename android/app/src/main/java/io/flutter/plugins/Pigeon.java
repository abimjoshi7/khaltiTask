...
public class Pigeon {
  ...
  public static final class MyMessage {
    ...
    private @NonNull Long test;

    public @NonNull Long getTest() {
      return test;
    }

    public void setTest(@NonNull Long setterArg) {
      if (setterArg == null) {
        throw new IllegalStateException("Nonnull field \"test\" is null.");
      }
      this.test = setterArg;
    }
    ...
    public static final class Builder {
      ...
      private @Nullable Long test;

      public @NonNull Builder setTest(@NonNull Long setterArg) {
        this.test = setterArg;
        return this;
      }
    ...
    static @NonNull MyMessage fromList(@NonNull ArrayList<Object> list) {
      ...
      pigeonResult.setTest((test == null) ? null : ((test instanceof Integer) ? (Integer) test : (Long) test));
      return pigeonResult;
    }
  }
